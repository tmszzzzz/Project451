...
public class PanelController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!_tutorialPanel.activeSelf && GlobalVar.instance.currentTask != 0 && GlobalVar.instance.currentTask < 32)
        {
    ...
    private void _changeNodeInfoPanleContenAndPosition(NodeBehavior node)
    {
        ...
        if (properties != null && NodeInfoPanel.activeSelf)
        {
            ...
            awakeThresholdText.text = "" + properties.awakeThreshold;
            exposeThresholdText.text = "" + properties.exposeThreshold;
            fallThresholdText.text = "" + properties.fallThreshold;
